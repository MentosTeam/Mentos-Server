...
public class SignUpRepository {
    ...
    public int createMember(SignUpReq signUpReq) {
        ...
        Object[] createUserParams = new Object[]{signUpReq.getMemberName(),signUpReq.getMemberNickName(),signUpReq.getMemberStudentId(),signUpReq.getMemberEmail(),signUpReq.getMemberPw(),signUpReq.getSchoolName(),signUpReq.getMemberSex()}; // 동적 쿼리의 ?부분에 주입될 값
