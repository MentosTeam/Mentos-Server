...
public class MentoringStatusRepository {
    ...
    public List<MentoringStatusRes> getMentorMentoringNowList(int memberId) {
        ...
        String getMentoringQuery = "select mentoringId, mentoringCount, majorCategoryId, mentoringMentos,mentoringStatus, mentoringCreateAt, mentoringUpdateAt from mentoring where mentoringMentoId = ? and mentoringStatus = 1"; // 해당 멤버를 만족하는 멘토링을 조회하는 쿼리문
    ...
    // 해당 멘토의 멘토링 정보 조회
    public List<MentoringStatusRes> getMentorMentoringEndList(int memberId) {
        String MentorSQL ="select memberName from member where memberId = ?";
        String mentoringMentorName = this.jdbcTemplate.queryForObject(MentorSQL,String.class, memberId);
        ...
        String getMentoringQuery = "select mentoringId, mentoringCount, majorCategoryId, mentoringMentos,mentoringStatus, mentoringCreateAt, mentoringUpdateAt from mentoring where mentoringMentoId = ? and mentoringStatus=2"; // 해당 멤버를 만족하는 멘토링을 조회하는 쿼리문
        int getMemberIdParams = memberId;
    ...
    public List<MentoringStatusRes> getMenteeMentoringNowList(int memberId) {
        ...
        String getMentoringQuery = "select mentoringId, mentoringCount, majorCategoryId, mentoringMentos, mentoringStatus, mentoringCreateAt, mentoringUpdateAt from mentoring where mentoringMentiId =? and mentoringStatus=1"; // 해당 멤버를 만족하는 멘토링을 조회하는 쿼리문
        int getMemberIdParams = memberId;
        return this.jdbcTemplate.query(getMentoringQuery,
                (rs, rowNum) -> new MentoringStatusRes(
                        rs.getInt("mentoringId"),
    ...
    // 해당 멘티의 멘토링 정보 조회
    public List<MentoringStatusRes> getMenteeMentoringEndList(int memberId) {
        String MenteeSQL ="select memberName from member where memberId = ?";
        String mentoringMenteeName = this.jdbcTemplate.queryForObject(MenteeSQL,String.class, memberId);
        ...
        String getMentoringQuery = "select mentoringId, mentoringCount, majorCategoryId, mentoringMentos, mentoringStatus, mentoringCreateAt, mentoringUpdateAt from mentoring where mentoringMentiId =? and mentoringStatus=2"; // 해당 멤버를 만족하는 멘토링을 조회하는 쿼리문
        int getMemberIdParams = memberId;
        return this.jdbcTemplate.query(getMentoringQuery,
                (rs, rowNum) -> new MentoringStatusRes(
                        rs.getInt("mentoringId"),
